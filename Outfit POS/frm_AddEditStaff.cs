...
{
    public partial class frm_AddEditStaff : Form
    {
        int LSStaffID;
        public frm_AddEditStaff(int staffID)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                (System.Windows.Forms.Application.OpenForms["frmListStaff"] as frm_ListStaff).LoadStaffs("");
            }
