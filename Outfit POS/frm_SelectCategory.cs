...
{
    public partial class frm_SelectCategory : Form
    {
        private frm_AddEditProduct frmProduct = null;

        public frm_SelectCategory(Form callingForm)
        {
            InitializeComponent();
            frmProduct = callingForm as frm_AddEditProduct;
        }
