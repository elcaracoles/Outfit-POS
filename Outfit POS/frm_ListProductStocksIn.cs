...
{
    public partial class frm_ListProductStocksIn : Form
    {
        int productID;
        public frm_ListProductStocksIn(int prodID)
        {
            InitializeComponent();
            productID = prodID;
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                (System.Windows.Forms.Application.OpenForms["frmListProduct"] as frm_ListProduct).LoadProducts("");
            }
