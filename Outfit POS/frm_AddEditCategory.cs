...
{
    public partial class frm_AddEditCategory : Form
    {
        int categoryID;
        public frm_AddEditCategory(int catID)
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                (System.Windows.Forms.Application.OpenForms["frmListCategory"] as frm_ListCategory).LoadCategories("");
            }
